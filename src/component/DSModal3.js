...
export default function DSModal3({ toggleModal3 }) {
			...
			<div className="modal-container">
				...
				<div className="modal-text">
					...
					<div className="modal-subhead">
						<FormattedMessage id="DS-modal-subhead 3" />
					</div>
					<div className="modal-detail">
						<ul>
							<FormattedMessage id="DS-modal-detail 3-1" />
						</ul>
						<br />
						<ul>
							<i>
								<FormattedMessage id="DS-modal-detail 3-2" />
							</i>
						</ul>
					</div>
				</div>
